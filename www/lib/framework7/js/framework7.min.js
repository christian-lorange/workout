			...
			if (!a.params.input || (a.input = o(a.params.input), 0 !== a.input.length || "dropdown" !== a.params.openIn)) {
				...
				return a.popup = void 0, a.dropdown = void 0, a.handleInputValue = function(e) {
					...
					if (!a.opened)
						...
						} else o(document).once("pageInit", ".autocomplete-page", a.pageInit), "popup" === a.params.openIn ? (a.popup = i.popup('<div class="popup autocomplete-popup autocomplete-popup-' + a.inputName + '"><div class="view navbar-fixed">' + w + "</div></div>"), a.popup = o(a.popup), a.popup.once("closed", function() {
